  ...
  return (
    <footer className="bg-white">
      ...
      <div className="bg-[#F8F9FE]">
        ...
        {/* Top row */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-10 text-center lg:text-left">
          ...
          <div className="sm:col-span-2 lg:col-span-1 flex flex-col items-center lg:items-start">
            <div className="flex items-center justify-center lg:justify-start gap-2.5 mb-4">
              <div className="w-9 h-9 rounded-xl bg-brand-purple flex items-center justify-center text-white shadow-md shadow-brand-purple/25">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
              </div>
              <span className="font-black text-[20px] tracking-tight text-brand-dark">growtopper</span>
            </div>
            <p className="text-gray-500 text-[13px] font-medium leading-relaxed mb-5 max-w-[240px] mx-auto lg:mx-0">
              India's first invite-only 30-day student growth program for Grades 6–12.
            </p>
            <a href="https://growtopper.app" className="text-[12px] text-brand-purple font-bold tracking-wide hover:underline">
              growtopper.app
            </a>
          </div>
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-x-4 gap-y-3 max-w-[280px] mx-auto lg:mx-0 text-center lg:text-left">
              {[
                ...
                <li key={l.label}>
                  <a href={l.href} className="text-[13px] font-medium text-gray-500 hover:text-brand-purple transition-colors">{l.label}</a>
                </li>
              ))}
              <li className="col-span-2 lg:col-span-1">
                <a href="#faq" className="text-[13px] font-medium text-gray-500 hover:text-brand-purple transition-colors">FAQ</a>
              </li>
            </ul>
          </div>
          ...
          {/* Legal */}
          <div>
            <h4 className="font-black text-brand-dark text-[13px] uppercase tracking-widest mb-4">Legal</h4>
            <ul className="grid grid-cols-2 gap-x-4 gap-y-3 max-w-[280px] mx-auto lg:mx-0 text-center lg:text-left">
              {[
          ...
          {/* Contact */}
          <div>
            <h4 className="font-black text-brand-dark text-[13px] uppercase tracking-widest mb-4">Contact</h4>
            <ul className="space-y-2.5 flex flex-col items-center lg:items-start">
              <li className="flex items-center gap-2 text-[13px] text-gray-500 font-medium">
                <Mail className="w-3.5 h-3.5 shrink-0 text-brand-purple" />
                Support@growtopper.app
              </li>
              <li className="flex items-center gap-2 text-[13px] text-gray-500 font-medium">
                <Phone className="w-3.5 h-3.5 shrink-0 text-brand-purple" />
                +91 78539 88799
              </li>
            </ul>
            <div className="flex items-center justify-center lg:justify-start gap-3 mt-5">
              {[
                ...
                <a key={i} href={href}
                  className="w-8 h-8 rounded-xl bg-white border border-gray-200 flex items-center justify-center text-gray-500 hover:text-brand-purple hover:border-brand-purple/30 transition-colors shadow-sm">
        ...
        {/* Bottom bar */}
        <div className="pt-6 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
          <p className="text-[12px] font-medium text-gray-400">
            © {new Date().getFullYear()} Growtopper Education. All rights reserved. | growtopper.app
          </p>
          <p className="text-[11px] text-gray-300 font-medium">Made with ❤️ in Bhubaneswar, India</p>
        </div>
