      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-16 gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <button aria-label="Scroll left" onClick={() => scroll('left')} className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-gray-500 hover:bg-gray-50 hover:text-brand-dark transition-all active:scale-95 shadow-sm">
              <ArrowLeft className="w-5 h-5" />
            </button>
            <button aria-label="Scroll right" onClick={() => scroll('right')} className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-gray-500 hover:bg-gray-50 hover:text-brand-dark transition-all active:scale-95 shadow-sm">
