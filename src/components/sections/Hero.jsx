...
const STUDENT_AVATARS = [
  'https://api.dicebear.com/9.x/notionists/svg?lips=&seed=Aanya&backgroundColor=b6e3f4',
  'https://api.dicebear.com/9.x/notionists/svg?lips=&seed=Rohan&backgroundColor=c0aede',
  'https://api.dicebear.com/9.x/notionists/svg?lips=&seed=Priya&backgroundColor=d1f0c4',
  'https://api.dicebear.com/9.x/notionists/svg?lips=&seed=Kabir&backgroundColor=ffd5dc',
  'https://api.dicebear.com/9.x/notionists/svg?lips=&seed=Sneha&backgroundColor=ffe4b5',
  'https://api.dicebear.com/9.x/notionists/svg?lips=&seed=Arjun&backgroundColor=dce8f5',
  'https://api.dicebear.com/9.x/notionists/svg?lips=&seed=Meera&backgroundColor=e8d5f5',
];
...
export default function Hero({ onRequestInvite }) {
  ...
  return (
    <section className="pt-20 lg:pt-24 pb-10 lg:pb-16 bg-[#F8F9FE] relative overflow-hidden flex flex-col justify-center items-center">
      ...
      <div className="hidden md:block absolute top-[-10%] left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-[#E8E2FF]/60 rounded-full blur-[100px] pointer-events-none z-0"></div>
