...
export default function Abode() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-[#111827] font-sans flex flex-col">
      ...
      <section className="px-4 sm:px-6 lg:px-8 w-full flex flex-col items-center justify-center min-h-[100dvh] pt-24 pb-8 max-w-7xl mx-auto">
        
        {/* Hero Headings */}
        <div className="text-center max-w-4xl mx-auto mb-6 sm:mb-8 w-full mt-auto">
          <h1 className="text-[36px] sm:text-[48px] md:text-[64px] font-black text-brand-dark leading-[1.05] tracking-tight mb-4 text-balance">
            Mentor for Everything.<br/>
            Get a mentor for <span className="text-[#5B10FF]">10X growth.</span>
          </h1>
          <p className="text-[14px] sm:text-[16px] text-gray-500 font-medium leading-relaxed mt-4 sm:mt-5">
        ...
        {/* The Card */}
        <div className="relative w-full max-w-[320px] sm:max-w-[340px] mx-auto scale-95 sm:scale-100 mb-auto">
          {/* Start Here Badge */}
          ...
          <div className="bg-white rounded-[32px] shadow-[0_20px_60px_rgba(0,0,0,0.06)] border border-gray-100 p-6 sm:p-8 flex flex-col items-center text-center relative z-0">
            ...
            <p className="text-[11px] sm:text-[12px] text-gray-400 font-medium mb-5 sm:mb-7">
              Includes our 30-min student test.
            </p>

            <div className="w-full h-px bg-gray-100 mb-5 sm:mb-7"></div>
