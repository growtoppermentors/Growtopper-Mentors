    ...
    <div className="min-h-[100dvh] bg-[#FAFAFA] text-[#111827] font-sans flex flex-col">
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-20 pt-8 max-w-4xl mx-auto w-full">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#EBF4FF] border border-[#D1E4FF] text-[#0055DD] text-[9px] sm:text-[10px] font-black uppercase tracking-widest mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white rounded-[24px] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.03)] p-6 md:p-8 hover:-translate-y-1 transition-transform duration-300">
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="px-2.5 py-1 rounded-md bg-green-50 text-green-700 text-[8px] font-black uppercase tracking-widest">PARENT STORY</div>
            </div>
            ...
            {[
              ...
              <div key={i} className="min-w-[280px] w-[280px] sm:min-w-[300px] sm:w-[300px] md:flex-1 shrink-0 snap-start bg-white rounded-[24px] border border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] flex flex-col hover:shadow-lg transition-shadow relative overflow-hidden">
                <div className={`h-[180px] ${m.bgLight} relative p-4 flex items-end justify-center rounded-t-[24px]`}>
                  ...
                  <img src={`https://api.dicebear.com/9.x/notionists/svg?lips=&seed=${m.seed}&backgroundColor=transparent`} className="w-32 h-32 object-contain" alt={m.name} />
                </div>
        ...
        <div className="bg-[#F9F4FF] rounded-[32px] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 border border-[#5B10FF]/10 shadow-sm relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10 relative z-10 text-center md:text-left">
            <div className="flex -space-x-3">
              {['A', 'B', 'C', 'D'].map((seed, i) => (
                <img key={i} src={`https://api.dicebear.com/9.x/notionists/svg?lips=&seed=${seed}&backgroundColor=transparent`} className="w-12 h-12 rounded-full border-2 border-white bg-white shadow-sm" alt="Student avatar" />
              ))}
            ...
            <div>
              ...
              <p className="text-[14px] text-gray-600 font-medium">Join 500+ families who trust Growtopper.</p>
            </div>
          </div>
          ...
          <div className="relative z-10 flex flex-col items-center md:items-end">
            ...
            <p className="text-[10px] text-gray-600 font-medium">Not a Coaching Class. Not an App.<br/>A Mentor for Everything.</p>
          </div>
        </div>
      </section>
      </main>
